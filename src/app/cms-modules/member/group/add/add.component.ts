...
import {
  ...
  FormInfoModel, InfoEnumModel, MemberGroupModel,
  MemberGroupService
} from 'ntk-cms-api';
...
export class MemberGroupAddComponent extends AddBaseComponent<MemberGroupService, MemberGroupModel, number> implements OnInit {
  constructor(
