...
import {
  ...
  FormInfoModel,
  ManageUserAccessDataTypesEnum, MemberPropertyAliasModel,
...
export class MemberPropertyAliasEditComponent extends EditBaseComponent<MemberPropertyAliasService, MemberPropertyAliasModel, number>
  implements OnInit {
  requestId = 0;
