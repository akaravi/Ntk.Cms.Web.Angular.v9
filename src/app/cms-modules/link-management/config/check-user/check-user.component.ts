...
import {
  ...
  ErrorExceptionResult, LinkManagementConfigurationService, TokenInfoModel
} from 'ntk-cms-api';
...
export class LinkManagementConfigCheckUserComponent implements OnInit, OnDestroy {
  ...
  onLoadDate(): void {
    ...
    this.translate.get('TITLE.Check_account').subscribe((str: string) => { this.publicHelper.processService.processStart(pName, str, this.constructor.name); });
    this.configService
