...
import {
  CoreEnumService, CoreModuleSiteUserCreditModel, CoreModuleSiteUserCreditService,
...
export class CoreModuleSiteUserCreditEditComponent extends EditBaseComponent<CoreModuleSiteUserCreditService, CoreModuleSiteUserCreditModel, number>
  implements OnInit {
  requestId = 0;
  constructor(
    ...
    super(coreModuleSiteUserCreditService, new CoreModuleSiteUserCreditModel(), publicHelper);
