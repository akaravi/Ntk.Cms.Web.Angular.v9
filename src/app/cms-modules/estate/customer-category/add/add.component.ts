...
import {
  CoreEnumService, DataFieldInfoModel, ErrorExceptionResult, EstateCustomerCategoryModel, EstateCustomerCategoryService, FormInfoModel} from 'ntk-cms-api';
...
export class EstateCustomerCategoryAddComponent extends AddBaseComponent<EstateCustomerCategoryService, EstateCustomerCategoryModel, string> implements OnInit {
  constructor(
