...
export class EstatePropertySupplierAddComponent extends AddBaseComponent<EstatePropertySupplierService, EstatePropertySupplierModel, string> implements OnInit, AfterViewInit {
  constructor(
