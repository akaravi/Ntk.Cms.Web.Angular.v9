...
import {
  CoreEnumService,
  ErrorExceptionResultBase, EstatePropertySupplierCategoryModel, EstatePropertySupplierCategoryService, EstatePropertyTypeModel, EstatePropertyTypeService, EstatePropertyTypeUsageModel, FilterDataModel, FilterModel, FormInfoModel,
...
export class EstatePropertySupplierCategoryEditComponent extends EditBaseComponent<EstatePropertySupplierCategoryService, EstatePropertySupplierCategoryModel, string>
  ...
  constructor(
    ...
    super(estatePropertySupplierCategoryService, new EstatePropertySupplierCategoryModel(), publicHelper, translate);
