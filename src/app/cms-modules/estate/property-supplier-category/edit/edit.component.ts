...
import {
  CoreEnumService, DataFieldInfoModel, ErrorExceptionResult, ErrorExceptionResultBase, EstatePropertySupplierCategoryModel, EstatePropertySupplierCategoryService, EstatePropertyTypeModel, EstatePropertyTypeService, EstatePropertyTypeUsageModel, FilterDataModel, FilterModel, FormInfoModel, InfoEnumModel, ManageUserAccessDataTypesEnum
} from 'ntk-cms-api';
...
export class EstatePropertySupplierCategoryEditComponent extends EditBaseComponent<EstatePropertySupplierCategoryService, EstatePropertySupplierCategoryModel, string>
implements OnInit {
  requestId = '';
  constructor(
  ...
  ) {super(estatePropertySupplierCategoryService, new EstatePropertySupplierCategoryModel(), publicHelper);
