...
import {
  ...
  CoreUserModel, DataFieldInfoModel, ErrorExceptionResult, EstateAccountUserModel, EstateAccountUserService, FormInfoModel,
  TokenInfoModel
} from 'ntk-cms-api';
...
export class EstateAccountUserAddComponent extends AddBaseComponent<EstateAccountUserService, EstateAccountUserModel, string> implements OnInit {
  constructor(
