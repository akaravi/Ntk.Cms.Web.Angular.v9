...
export class EstateAccountAgencyUserAddComponent extends AddBaseComponent<EstateAccountAgencyUserService, EstateAccountAgencyUserModel, string> implements OnInit {
  ...
  constructor(
    ...
    super(estateAccountAgencyUserService, new EstateAccountAgencyUserModel(), publicHelper, translate);
