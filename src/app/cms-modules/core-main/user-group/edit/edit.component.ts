...
import {
  CoreEnumService, CoreUserGroupModel, CoreUserGroupService,
...
export class CoreUserGroupEditComponent extends EditBaseComponent<CoreUserGroupService, CoreUserGroupModel, number>
  implements OnInit {
  requestId = 0;
  constructor(
