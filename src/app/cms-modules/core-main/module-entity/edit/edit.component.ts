...
import {
  CoreEnumService, CoreModuleEntityModel, CoreModuleEntityService,
...
export class CoreModuleEntityEditComponent extends EditBaseComponent<CoreModuleEntityService, CoreModuleEntityModel, number>
  implements OnInit {
  requestId = 0;
  ...
  constructor(
    ...
    super(coreModuleEntityService, new CoreModuleEntityModel(), publicHelper, translate);
