...
import {
  CoreCurrencyModel, CoreCurrencyService, CoreEnumService,
...
export class CoreCurrencyEditComponent extends EditBaseComponent<CoreCurrencyService, CoreCurrencyModel, number>
  implements OnInit {
  requestId = 0;
  constructor(
